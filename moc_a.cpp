...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_a_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_a_t qt_meta_stringdata_a = {
    {
QT_MOC_LITERAL(0, 0, 1)
    },
    "a\0"
};
...
const QMetaObject a::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_a.data,
      qt_meta_data_a,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_a.stringdata))
